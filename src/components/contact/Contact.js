...
const Contact = () => {
  ...
  const handleSubmit =(e)=>{
    ...
    emailjs.send("service_3s0c43f", 'template_6ozx66e', data, 'XoIjaz7gfr1dCmxaA')
      .then((result) => {
          if(result.text === 'OK'){
            toast.success('👍 Your Msg Sent Successfully to Jeevitha Srinivasan ', {
              position: "top-center",
              autoClose: 5000,
  ...
  return (
    <div id='contact' className='contactFull'>
       ...
       Contact <span className="underline__effect">Details</span>
          </Typography>
      <br/>
        ...
        <div  className='d-flex justify-content-around align-items-center flex-wrap'>
          ...
          <div className='compRight' >
            <Paper elevation={16}>
               ...
               <div>
                  <PhoneIcon />   +91 7395976461
                </div>
                <div>
                  <EmailIcon />  jeevithasrinivasan97@gmail.com
                </div>
                <div>
                  <HomeIcon />   Choolai, Chennai - 600 112
                </div>
                <div>
                  <GitHubIcon />  <a href="https://github.com/JEEVITHASRINI97">https://github.com/JEEVITHASRINI97</a>
                </div>
               </div>
            </Paper>
          </div>
